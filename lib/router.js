  ...
  user.getUserInfo(userID)
    .then( function (result) {
      let bodyText = '<head>\n'
            ...
            + '                text \n'
            + '                  += "<input type=\'radio\' id = \'" + i + "-" + p + "-" + ii + "\' name=\'" + p + "\' value=\'" + (ii+1) + "\' hasSubTextInput=true>"\n'
            + '                  + options[ii].text[language]\n'
            + '                  + "<input type=\'text\' id = \'" + i + "-" + p + "-" + ii + "\' name=\'" + p  + "\' disabled = true>";\n'
            + '              }\n'
            + '              else\n'
            + '              {\n'
            ...
            + '     $( this ).siblings("input:radio").click( function () { \n'
            ...
            + '           ( $( this ).attr("type") == "7 liker scale" || $( this ).attr("type") == "selection" )) { \n'
