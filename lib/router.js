  ...
  user.getUserInfo(userID)
    .then( function (result) {
      let bodyText = '<head>\n'
            ...
            + 'var prices = [' + result.price1 + ', ' + result.price2 + ', ' + result.price3 + ', ' + result.price4 + ', ' + result.price5 + ', ' + result.price6 + '];\n'
            + 'var finalPrice;\n'
            ...
            // 5 liker scale
            + '          else if (surveyQuestions[p].type == \'5 liker scale\')\n'
            + '          {\n'
            + '            text +=\n'
            ...
            + '            console.log(\'unknown question type error: \' + surveyQuestions[p].type);\n'
            + '          }\n'
