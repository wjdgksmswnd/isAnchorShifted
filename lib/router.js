  ...
  user.getUserInfo(userID)
    .then( function (result) {
      let bodyText = '<head>\n'
            ...
            + 'var liker7 = ["매우 부정적", "부정적", "다소 부정적", "보통", "다소 긍정적", "긍정적", "매우 긍정적"];\n'
            ...
            + '          {\n'
            + '            text +=\n'
            + '                "<input type=\'radio\' name=\'" + p + "\' value=\'1\'>" + liker7[0]\n'
            + '              + "<input type=\'radio\' name=\'" + p + "\' value=\'2\'>" + liker7[1]\n'
            + '              + "<input type=\'radio\' name=\'" + p + "\' value=\'3\'>" + liker7[2]\n'
            + '              + "<input type=\'radio\' name=\'" + p + "\' value=\'4\'>" + liker7[3]\n'
            + '              + "<input type=\'radio\' name=\'" + p + "\' value=\'5\'>" + liker7[4]\n'
            + '              + "<input type=\'radio\' name=\'" + p + "\' value=\'6\'>" + liker7[5]\n'
            + '              + "<input type=\'radio\' name=\'" + p + "\' value=\'7\'>" + liker7[6];\n'
            + '          }\n'
            ...
            + '          + \'<input type="radio" name = "offerAnswer" value=2> Suggest\' \n'
            + '          + \'<input type="text"  name = "offerAnswer">\' \n'
            + '          + \'<input type="radio" name = "offerAnswer" value=0> Decline\' ; \n'
            + '        body.push(text);\n'
            + '      }\n'
            + '    }\n'
            + '  }\n'
            ...
            + '         objString += \'"price" : "\' + $("div#answer").find(\'input:text\').val() + \'", \'; \n'
